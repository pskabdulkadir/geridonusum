...
2. **Ücretsiz İşletim (Zero-Gas Mode & Gas Fee Bypassing)**:
   - Uygulama işlemlerinde asla doğrudan `PRIVATE_KEY` kullanarak gas fee harcanmaz. Sadece `payoutWalletAddress` (0x02cc8aBBADf0ad5183f5e9Bb2BF469e506a133e4) cüzdan adresi üzerinden para kabul edilir.
...
4. **Gelir Transferi ve Otomatik Yönlendirme**:
   - Kontrata gelen her ödeme (USDT/POL), otomatik olarak kullanıcının tanımladığı payout cüzdan adresine (`0x02cc8aBBADf0ad5183f5e9Bb2BF469e506a133e4`) anlık olarak çekilir/yönlendirilir.
